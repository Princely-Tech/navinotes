        ...
        children: [
                ...
                child: _isEditingName
                    ? TextField(
                        ...
                        onSubmitted: (value) {
                          ...
                          if (value.trim().isNotEmpty && value.trim() != widget.voiceNote.name) {
                            widget.vm.updateVoiceNoteName(widget.index, value.trim());
                          }
                        },
                        autofocus: true,
                      )
          ...
          Row(
            children: [
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SliderTheme(
                      ...
                      child: Slider(
                        value: widget.isPlaying && widget.vm.currentlyPlayingIndex == widget.index
                            ? (widget.vm.totalDuration.inMilliseconds > 0
                                ? widget.vm.currentPosition.inMilliseconds /
                                    widget.vm.totalDuration.inMilliseconds
                                : 0.0)
                            : 0.0,
                        onChanged: (value) {
                          if (widget.isPlaying && widget.vm.currentlyPlayingIndex == widget.index) {
                            final position = Duration(
                              milliseconds:
                                  (value * widget.vm.totalDuration.inMilliseconds).round(),
                            );
              ...
              // Duration
              Text(
                widget.isPlaying && widget.vm.currentlyPlayingIndex == widget.index
  ...
  Widget _buildStaticWaveform() {
    return Row(
      ...
      children: List.generate(20, (index) {
        final heights = [0.3, 0.7, 0.4, 0.8, 0.5, 0.9, 0.6, 0.3, 0.7, 0.4,
                        0.8, 0.5, 0.6, 0.9, 0.3, 0.7, 0.4, 0.8, 0.5, 0.6];
        return Container(
          width: 2,
      ...
      builder: (context, child) {
        return Row(
          ...
          children: List.generate(20, (index) {
            final heights = [0.3, 0.7, 0.4, 0.8, 0.5, 0.9, 0.6, 0.3, 0.7, 0.4,
                            0.8, 0.5, 0.6, 0.9, 0.3, 0.7, 0.4, 0.8, 0.5, 0.6];
            final animatedHeight = heights[index % heights.length] * 
