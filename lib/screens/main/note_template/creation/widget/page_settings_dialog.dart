...
class PageSettingsDialog extends StatefulWidget {
  ...
  final BoardNoteTemplate? currentTemplate;
  final Function(BoardNoteTemplate)? onTemplateChanged;
...
class _PageSettingsDialogState extends State<PageSettingsDialog> {
  ...
  void initState() {
    ...
    if (_selectedFormat.size == PageSize.custom &&
        _selectedFormat.customSize != null) {
      _customWidthController.text =
          _selectedFormat.customSize!.width.toInt().toString();
      _customHeightController.text =
          _selectedFormat.customSize!.height.toInt().toString();
    } else {
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              // Template Section (if template callback is provided)
  ...
  Widget _buildOrientationSelector() {
    return Row(
      children:
          PageOrientation.values.map((orientation) {
    ...
    return Container(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          final isSelected = widget.currentTemplate?.type == template.type;
