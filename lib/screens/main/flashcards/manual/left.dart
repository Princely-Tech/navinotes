...
class FlashCardsManualCreationLeft extends StatelessWidget {
  const FlashCardsManualCreationLeft({super.key});
  ...
  Widget _deckManagement(FlashCardsManualCreationVm vm) {
    ...
    return _sections(
      ...
      child: Column(
        ...
        children: [
          CustomInputField(
            label: 'Deck Name',
            controller: vm.deckNameController,
            focusNode: vm.deckNameFocusNode,
          ...
          Row(
            ...
            children: [
              ...
              Text(
                vm.userFlashCards.length.toString(),
                style: AppTheme.text.copyWith(
