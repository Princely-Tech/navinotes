...
class MarketPlaceScreen extends StatelessWidget {
            ...
            child: Consumer<MarketPlaceVm>(
              builder: (context, vm, _) {
                ...
                return ScaffoldFrame(
                  scaffoldKey: _scaffoldKey,
                  drawer: CustomDrawer(child: MarketPlaceAside(vm: vm)),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: ResponsiveSection(
                          mobile: _mainWidget(vm: vm, context: context),
                          desktop: Row(
            ...
            children: [
              ...
              Expanded(
                child: ScrollableController(
                  ...
                  onEndReached: vm.hasMorePages ? vm.loadNextPage : null,
                  child: Column(
                    spacing: 30,
                    children: [
                      _featured(vm: vm),
  ...
  Widget _header(MarketPlaceVm vm, BuildContext context) {
